...
const CSV_PATH = path.resolve(DATA_DIR, 'latest-natural-diamond.csv')
const VALID_IDS_PATH = path.resolve(DATA_DIR, 'valid-natural-ids.json')
const EXISTING_IDS_PATH = path.resolve(DATA_DIR, 'existing-natural-ids.json')
