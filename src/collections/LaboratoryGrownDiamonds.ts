...
export const LaboratoryGrownDiamonds: CollectionConfig = {
  ...
  fields: [
    ...
    { name: 'gdc_aset', label: 'GDC Aset', type: 'text' },
    { name: 'gdc_aset_link', label: 'GDC Aset Link', type: 'text' },
    { name: 'ethereal_aset', label: 'Ethereal Aset', type: 'text' },
    { name: 'ethereal_vid_1', label: 'Ethereal Video 1', type: 'text' },
    { name: 'ethereal_vid_2', label: 'Ethereal Video 2', type: 'text' },
    { name: 'ethereal_cut', label: 'Ethereal Cut', type: 'text' },
